import { Button, NoDataMessage, Table, TableCell, TableRow, TableSkeleton, StatusBadge, Tooltip } from "../../../../components/ui";
...
const AdminsTable = ({ admins, isLoading, handleDelete, handleUnblock }: Props) => {
      ...
      {isLoading ? (
        ...
        <Table columns={columns}>
          ...
          {admins.length == 0 ? (
            ...
            admins.map(({ id, username, title, email, isBlocked, createdAt }: AdminData) => (
