import { IAttendanceWithVacationsData } from "../../../../interfaces";
...
interface ITableProps {
  attendanceWithVacations: IAttendanceWithVacationsData[];
  isLoading: boolean;
}

const VacationsTable = ({ attendanceWithVacations, isLoading }: ITableProps) => {
