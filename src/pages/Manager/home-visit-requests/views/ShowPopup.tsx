        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-xl shadow-lg">
          <div className="flex flex-col items-center space-y-3">
            <div className="bg-gray-200 p-4 rounded-full">
              <Home size={80} className="text-gray-600" />
            </div>
          ...
          <div className="mt-6 space-y-4 divide-y divide-gray-300">
            <div className="grid grid-cols-2 py-2">
              ...
              <span className="text-gray-900 font-semibold">
                {formatValue(request?.employeeId || 0, language)}
              </span>
            </div>
            <div className="grid grid-cols-2 py-2">
              <span className="font-medium text-gray-600">
              ...
              <span className="text-gray-900 font-semibold">
                {formatValue(request?.employeeName || 0, language)}
              </span>
            </div>
            <div className="grid grid-cols-2 py-2">
              <span className="font-medium text-gray-600">
              ...
              <span className="text-gray-900 font-semibold">
                {formatValue(request?.id || 0, language)}
              </span>
            </div>
            <div className="grid grid-cols-2 py-2">
              <span className="font-medium text-gray-600">
