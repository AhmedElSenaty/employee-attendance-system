                  ...
                  requests.map((request: IRequest) => (
                    <TableRow key={request.id} className="border-b">
                      ...
                      <TableCell label={columns[2]}>
                        {new Date(request.startDate).toLocaleDateString(language)}
                      </TableCell>
                      ...
                      <TableCell label={columns[4]}>
                        {new Date(request.startDate).toLocaleTimeString(language, {
                          hour: "2-digit",
                          minute: "2-digit",
                        })}
                      </TableCell>
                      ...
                      <TableCell label={columns[5]}>
                        {new Date(request.endDate).toLocaleTimeString(language, {
                          hour: "2-digit",
                          minute: "2-digit",
                        })}
                      </TableCell>
                      ...
                      <TableCell label={columns[7]}>
                        <StatusBadge
                          variant={getRequestStatusVariant(request.requestStatus)}
                          size="medium"
                          shape="rounded"
                        >
                      ...
                      <TableCell label={columns[8]}>
                        {new Date(request.requestedDate).toLocaleString(language, {
                          day: "2-digit",
                          month: "2-digit",
                          year: "numeric",
                          hour: "2-digit",
                      ...
                      <TableCell label={columns[9]}>
                        <HasPermission permission="Accept/Reject Requests">
                          {request.requestStatus === RequestStatusType.Pending && (
                            <div className="flex gap-2">
                              <Tooltip content={t("table.buttons.toolTipAccept")}>
                                <Button
                                  ...
                                  onClick={() => handleAcceptPopupOpen(request.id)}
                                />
                              </Tooltip>
