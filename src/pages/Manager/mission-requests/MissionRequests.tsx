...
import { useAcceptMissionRequest, useGetMissionRequestByID, useGetMissionRequests, useRejectMissionRequest } from "../../../hooks/mission.hooks";
import { IRejectMissionRequestCredentials } from "../../../interfaces";
import MissionRequestsTable from "./views/MissionRequestsTable";
...
const MissionRequests = () => {
  ...
  const { missionRequests, totalMissionRequests, metadata, isMissionRequestsLoading } = useGetMissionRequests(
    page,
    pageSize,
    startDate,
    endDate,
  ...
  const { missionRequest, isMissionRequestLoading } = useGetMissionRequestByID(selectedID);
  ...
  const handleConfirmReject = handleSubmit((request: IRejectMissionRequestCredentials) => {
    ...
    <div className="sm:p-5 p-3 space-y-5">
      ...
      <div className="space-y-5 mx-auto w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl">
        <CountCard 
            ...
            count={formatValue(totalMissionRequests, language)}
      ...
      <div className="bg-white shadow-md space-y-5 p-5 rounded-lg">
        ...
        />
          ...
          <div className="w-full overflow-x-auto">
            <MissionRequestsTable missionRequests={missionRequests} isLoading={isMissionRequestsLoading} handleShow={handleShowPopupOpen} handleAccept={handleAcceptPopupOpen} handleReject={handleRejectPopupOpen} />
          </div>
