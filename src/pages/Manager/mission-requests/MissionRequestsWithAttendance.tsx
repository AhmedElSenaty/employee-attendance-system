...
import { useGetMissionRequestsWithAttendance } from "../../../hooks";
import { useDebounce } from "../../../hooks";
import { Header, Paginator, SectionHeader } from "../../../components/ui";
import { LEAVE_REQUESTS_NS } from "../../../constants";
import { MissionRequestsWithAttendanceTable, TableFilters } from "./views";

const MissionRequestsWithAttendance = () => {
  ...
  const { missionRequests, metadata, isMissionRequestsLoading } = useGetMissionRequestsWithAttendance(
    page,
    pageSize,
    startDate,
    endDate,
    ...
    <div className="sm:p-5 p-3 space-y-5">
      ...
      <div className="bg-white shadow-md space-y-5 p-5 rounded-lg">
        ...
        <div className="w-full overflow-x-auto">
          <MissionRequestsWithAttendanceTable leaveRequests={missionRequests} isLoading={isMissionRequestsLoading} />
        </div>
...
export default MissionRequestsWithAttendance;
