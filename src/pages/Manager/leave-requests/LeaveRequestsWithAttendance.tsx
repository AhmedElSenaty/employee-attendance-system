...
import { useGetLeaveRequestsWithAttendance } from "../../../hooks";
import { useDebounce } from "../../../hooks/";
import { Header, Paginator, SectionHeader } from "../../../components/ui";
import { LEAVE_REQUESTS_NS } from "../../../constants";
import { LeaveRequestsWithAttendanceTable, TableFilters } from "./views";

const LeaveRequestsWithAttendance = () => {
  ...
  const { leaveRequests, metadata, isLeaveRequestsLoading } = useGetLeaveRequestsWithAttendance(
    page,
    pageSize,
    startDate,
    endDate,
    ...
    <div className="sm:p-5 p-3 space-y-5">
      ...
      <div className="bg-white shadow-md space-y-5 p-5 rounded-lg">
        ...
        <div className="w-full overflow-x-auto">
          <LeaveRequestsWithAttendanceTable leaveRequests={leaveRequests} isLoading={isLeaveRequestsLoading} />
        </div>
...
export default LeaveRequestsWithAttendance;
