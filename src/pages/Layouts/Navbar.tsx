    ...
    <header className="z-30 shadow-lg sticky top-0 py-3 w-full h-fit bg-[var(--color-primary)]">
      <nav className="sm:mx-16 mx-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-5">
          ...
          >
            <FlyoutMenu className="w-45 border-0.5 bg-white shadow-md rounded-2xl text-base transition duration-300 ease-in-out">
          ...
          {isLoggedIn ? (
            ...
            >
              <FlyoutMenu className="border-0.5 w-[280px] bg-white shadow-md rounded-2xl text-lg transition duration-300 ease-in-out">
                <div className="p-3">
                  {/* Home Link */}
                  <NavLink
