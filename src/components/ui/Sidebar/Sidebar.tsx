...
const Sidebar = ({ title, subtitle, children }: SidebarProps) => {
  ...
  return (
    <>
      ...
      <aside className="flex flex-col items-center sm:gap-5 py-8 w-11 sm:w-18 h-screen shadow-lg shadow-primary sticky bg-gray-100 left-0 top-0">
        <button
          className="sm:w-12 sm:h-12 w-8 h-8 inline-flex items-center justify-center 
                    ...
                    bg-[#19355a] text-[#ffffff] hover:bg-[#27285d]"
