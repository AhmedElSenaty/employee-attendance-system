  ...
  return (
    ...
    >
      ...
      <div className="flex gap-3 justify-end">
        <Tooltip
          content={t("casualLeaveRequestCard.toolTipViewButton")}
          placement="top"
        >
          <Button
            variant="primary"
        ...
        {data.status == RequestStatusType.Pending && (
          <Tooltip
            content={t("casualLeaveRequestCard.toolTipEditButton")}
            placement="top"
          >
            <Button
              variant="info"
...
export default CasualLeaveRequestCard;
