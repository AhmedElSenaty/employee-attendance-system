    ...
    <div className="max-w-[1000px] h-fit mx-auto bg-white shadow rounded-lg overflow-hidden flex flex-wrap items-center justify-center gap-4 p-6 space-x-6">
      ...
      <div className="flex-1 space-y-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2 text-sm">
          <p>
            <span className="font-medium">{t("table.columns.email")}:</span>{" "}
            {user.email}
          </p>
          <p>
            <span className="font-medium">{t("table.columns.username")}:</span>{" "}
            {user.username}
          </p>
          <p>
          ...
          <p>
            <span className="font-medium">{t("table.columns.ssn")}:</span>{" "}
            {user.ssn}
          </p>
          <p>
            <span className="font-medium">
          ...
          <p>
            <span className="font-medium">
              {t("table.columns.hiringDate")}:
            </span>{" "}
            {user.hiringDate}
          </p>
          <p>
            <span className="font-medium">
              {t("table.columns.delegateDepartmentName")}:
            </span>{" "}
            {user.delegeteName}
          </p>
          <p>
            <span className="font-medium">
              {t("table.columns.delegateSubDepartmentName")}:
            </span>{" "}
            {user.delegeteSubDepartmentName}
          </p>
        </div>
