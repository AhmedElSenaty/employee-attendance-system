...
import { SelectHTMLAttributes, ReactNode, Ref, forwardRef } from "react";
...
const SelectBox = forwardRef(({ isError = false, children, ...rest }: SelectBoxProps, ref: Ref<HTMLSelectElement>) => {
  return (
