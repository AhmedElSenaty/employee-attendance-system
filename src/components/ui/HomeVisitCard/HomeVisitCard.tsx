...
import { FilePenLine, Info, MessageSquare, Eye, ArrowLeftRight } from "lucide-react";
...
type Props = {
  data: HomeVisitDetails;
  handleShow: (id: number) => void;
  handleEdit: (id: number) => void;
  handleChange: (id: number) => void;
};

const HomeVisitCard = ({ data, handleShow, handleEdit, handleChange }: Props) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-3 justify-end">
        <Tooltip
          content={t("homeVisitCard.toolTipViewButton")}
          placement="top"
        >
          <Button
            variant="primary"
        ...
        <Tooltip
          content={t("homeVisitCard.toolTipEditButton")}
          placement="top"
        >
          <Button
            variant="info"
        ...
        <Tooltip
          content={t("homeVisitCard.toolTipChangeButton")}
          placement="top"
        >
          <Button
            variant="warning"
